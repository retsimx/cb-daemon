...
/// Register dump / flush-all `setCAN` (`CRC = 0x5a`). Trailing space is required.
pub(crate) const DUMP_SET_CAN: &[u8] = b"setCAN 0701000000600000000000000 ";
...
mod tests {
    ...
    fn golden_payload_crcs() {
        ...
        assert_eq!(crc8(DUMP_SET_CAN), 0x5a);
    }

    #[test]
    fn dump_trailing_space_preserved() {
        assert!(DUMP_SET_CAN.ends_with(b" "));
        assert_eq!(DUMP_SET_CAN, b"setCAN 0701000000600000000000000 ");
    }
