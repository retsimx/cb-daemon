...
fn golden_write_can_round_trip() {
    let raw = r#"{"type":"write_can","msg_id":"req-301","tokens":["0703181f30120090000000001"]}"#;
    ...
    match &msg {
        ClientMessage::WriteCan { msg_id, tokens } => {
            ...
            assert_eq!(tokens, &vec!["0703181f30120090000000001".to_owned()]);
        }
    ...
    assert_eq!(parsed["tokens"][0], "0703181f30120090000000001");
}
